...
// Fall 2019 Midterm Review: Topics
...
void module_01_numbers(){
	...
	double keepDecimals = 7/2;// this stores 3.5, since double's hold decimal places.
	...
	/* ================ Numerical Maths ================ */
	cout << "\n\n\n"; // (just a spacer for the command window)
	...
	cout << "y value: ";
	cin >> y;
	poly = double(x) * double(x) + double(y) * double(y) - 1.0;
